...
export class PropertyService {
    ...
    private shapeMatchQuery(match: T, input: PropertiesInquiry): void {
        ...
        if(pagesRange) match.propertyPages = { $gte: pagesRange.start, $lte: pagesRange.end}
    ...
    public async getAuthorProperties(memberId: ObjectId, input: AuthorPropertiesInquiry):Promise<Properties> {
    ...
    public async getAllPropertiesByAdmin(input: AllPropertiesInquiry): Promise<Properties> {
        ...
        if(propertyCategoryList) match.propertyCategory = propertyCategoryList[0];
